...
![Initial Astar Island Map](https://app.ainm.no/docs/astar-island/map-initial.png)
...
![Same map, different stochastic outcomes](https://app.ainm.no/docs/astar-island/stochastic-outcomes.png)

![Viewport: you only see a small window of the full map](https://app.ainm.no/docs/astar-island/viewport-demo.png)
