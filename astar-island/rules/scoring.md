...
![Probability tensor — per-cell class probabilities](https://app.ainm.no/docs/astar-island/probability-tensor.png)
...
- [Score Formula](https://app.ainm.no/docs/astar-island/scoring#score-formula)
- [Ground Truth](https://app.ainm.no/docs/astar-island/scoring#ground-truth)
- [KL Divergence](https://app.ainm.no/docs/astar-island/scoring#kl-divergence)
- [Entropy Weighting](https://app.ainm.no/docs/astar-island/scoring#entropy-weighting)
- [Final Score](https://app.ainm.no/docs/astar-island/scoring#final-score)
- [Common Pitfalls](https://app.ainm.no/docs/astar-island/scoring#common-pitfalls)
- [Per-Round Score](https://app.ainm.no/docs/astar-island/scoring#per-round-score)
- [Leaderboard](https://app.ainm.no/docs/astar-island/scoring#leaderboard)
- [Game End](https://app.ainm.no/docs/astar-island/scoring#game-end)
