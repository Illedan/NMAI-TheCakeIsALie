...
![Terrain Types](https://app.ainm.no/docs/astar-island/terrain-types.png)
...
![Simulation Phases](https://app.ainm.no/docs/astar-island/simulation-phases.png)
...
![Faction dynamics — settlements change color as allegiances shift](https://app.ainm.no/docs/astar-island/faction-dynamics.gif)
...
Each settlement tracks: position, population, food, wealth, defense, tech level, port status, longship ownership, and faction allegiance (owner\_id).
...
![50-year simulation](https://app.ainm.no/docs/astar-island/simulation.gif)

Initial state vs. after 50 years of simulation:

![Before and after](https://app.ainm.no/docs/astar-island/simulation-before-after.png)

With high expansion, settlements rapidly colonise available land:

![High expansion simulation](https://app.ainm.no/docs/astar-island/expansion.gif)
